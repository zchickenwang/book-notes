...
* Never Underestimate Exponential Growth
  ...
  The world runs by power law (power law, Parento principle, 80-20 rule...): that the majority of value is generated by a minority. Whether it's pea plants production, earthquake magnitues, city populations, or monopoly profits, everything obeys this distribution. Even Einstein called compound interest "the greatest mathematical discovery of all time" and "the most powerful force in the universe".
...
* Rules for VC's    
  This highly-skewed distribution in returns suggests two guiding principles:
...
* Mistakes VC's Make    
  ...
  * Not seeing the power law. At the end of a fund's lifespan, its investments will be split between 1 dominant company and everything else. However, a VC manager's daily experience--attending to early-stage investments and making new ones--reflects a homogenous pool where variance amongst companies is negligible.    
  * Spending more time with failing companies. Instead of betting more on the early winners, many VC's will put more effort into helping stragglers.     
  This resembles Thiel's approach to education, where kids that are good at math should go all-in on it; studying anything else is a just waste of bandwidth.

* What This Means for Entrepreneurs    
  First of all, reconsider starting a company. "The power law means that differenes *between* companies will dwarf the differences in roles *inside* companies" (91). Owning 1% of the next GAFA will dwarf any majority stake in a less-successful venture.    
  If you do start your own company, remember that a single market, distribution strategy, decision, will likely dominate all others. In a society blind to the power law, "what's most important is rarely obvious" (92).
