...
* Never Underestimate Exponential Growth
  ...
  The world runs by power law (power law / Parento principle / 80-20 rule): that the majority of value is generated by a minority. Whether it's pea plant production, earthquake magnitudes, city populations, or monopoly profits, everything obeys this distribution. Einstein even called compound interest "the greatest mathematical discovery of all time" and "the most powerful force in the universe".

* The Power Law in Venture Capital    
  Most venture-backed companies aren't immediately profitable--venture funds rely on a few of them hitting exponential growth a few years down the line.    Or as Thiel says, relying on just a single company:
  > The biggest secret in venture capital is that the best investment in a successful fund equals or outperforms the entire rest of the fund combined. (86)

* Rules for VC's    
  This highly-skewed distribution of returns implies two guiding principles:
  * **Rule 1:** Only invest in companies that have the potential to return the value of the entire fund. This is a scary rule because it eliminates almost every potential investment! Even highly-successful companies like Instagram, out of whose exit Andreessen Horowitz netted a cool $78 million (a 312x return in <2 years), wasn't enough for the fund to break even--a16z would've needed 20 Instagrams to make a profit.    
  * **Rule 2:** "Because Rule 1 is so restrictive, there can't be any other rules" (86).

* Mistakes VC's Make    
  * Adopting a "spray and pray" approach. If you think venture company returns are normally distributed, then it makes sense to diversify. But this violates Rule 1. Evaluating companies based on a hedging strategy (au lieu of business substance) makes investing look like playing the lottery. "You've already psychologically prepared yourself to lose" (87).    
  * Not seeing the power law. At the end of a fund's lifespan, its investments will be split between one dominant company and everyone else. However, a VC manager's daily experience--attending to early-stage investments and making new ones--reflects a homogenous pool where variance amongst companies is negligible.    
  * Spending more time with failing companies. Many VC's will put most of their effort into helping straggling investments instead of betting more on early winners.
  This attitude resembles Thiel's approach to education, where kids that are good at math should go all-in on it; studying anything else is a just waste of bandwidth.

* What This Means for Entrepreneurs    
  First of all, reconsider starting a company. "The power law means that differences *between* companies will dwarf the differences in roles *inside* companies" (91). Owning 1% of the next GAFA will dwarf any majority stake in a less-successful venture.    
  If you do start your own company, remember that a single market / distribution strategy / meeting / decision will likely dominate all others. In a society blind to the power law, "what's most important is rarely obvious" (92).

* What This Means for Everyone Else    
  Every person is an investor in his or her own time and effort. You can't run a dozen different companies, or keep a hedge fund of a dozen possible careers. So remember that you've been taught a lie--do put all your eggs in one basket.

* Another Rant about Schools    
  > Every high school course period lasts 45 minutes whatever the subject. Every student proceeds at a similar pace. "It doesn't matter what you do, as long as you do it well." That is completely false. (91)

  It will be really interesting to see education systems that leverage (any) technology. Public schools in particular are a complete disaster--this reflects the ignorance of politicans to technology, which in turn reflects the ignorance of the majority of Americans (see the House Judiciary Committee asking Sundar Pichai if there's "a little man, sitting behind the curtain, figuring out what we're going to show" on SRP's). Smart curriculums tailored to each student's interests and skills would be revolutionary; but sadly, improving education is just another field where the lack of funding means a lack of talent ("Follow the Money", right Peter).
